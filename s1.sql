...
CREATE SEQUENCE afdeling_nummer_sequence
    START WITH 10
    INCREMENT BY 10;
...
ALTER TABLE medewerkers ADD CONSTRAINT verkoper_commissie_check CHECK ((functie = 'VERKOPER' AND comm IS NOT NULL) OR (functie <> 'VERKOPER' AND comm IS NULL));
