...
SELECT afdelingen.naam AS afdeling_naam, medewerkers.naam AS medewerkers_naam FROM afdelingen
...
SELECT medewerkers.naam AS medewerkers_naam, afdelingen.naam As afdeling_naam, afdelingen.locatie FROM medewerkers
